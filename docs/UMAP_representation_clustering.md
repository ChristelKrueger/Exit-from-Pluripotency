...
<figure markdown>
  ![UMAP with EM clusters](./images/UMAP_EM_clusters.png){ width="600"; align=left }
</figure>


<figure markdown>
  ![UMAO with Louvain clusters](./images/UMAP_Louvain_clusters.png){ width="600"}{align=left; align=left}
</figure>
